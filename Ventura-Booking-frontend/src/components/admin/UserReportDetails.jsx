        ...
        <div className="animate-fade-in p-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div className="p-8 grid md:grid-cols-2 gap-8">
                    <div>
                        <h3 className="text-lg font-semibold text-gray-800 mb-4 border-b pb-2">User Information</h3>
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-gray-900">{report.email}</p>
                            </div>
                            ...
                            {!user && (
                                <p className="text-sm text-gray-400 italic mt-4">Guest User (No registered account found)</p>
                            )}
                        </div>
                    </div>
                ...
                <div className="p-6 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
                    {report.status !== 'viewed' && report.status !== 'completed' && (
                        <button
